...
const _tabs = <_Tab>[
  ...
  _Tab('/visualize', 'Visualize', LucideIcons.sparkles),
              ...
              Positioned(
                ...
                child: SafeArea(
                  ...
                  child: Padding(
                    ...
                    child: _BottomNav(location: location, onNavigate: onNavigate),
                  ),
                ),
              ),
            ],
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: const [
          BoxShadow(color: Color(0x593D2A17), blurRadius: 50, offset: Offset(0, 20), spreadRadius: -20),
        ],
      ),
      child: Row(
